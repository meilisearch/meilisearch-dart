...
class Meili {
  ...
  static Iterable<MeiliHighlightableStringPart> parseHighligtableString({
    ...
    if (preIndex < 0 || postIndex < 0) {
      ...
      if (beforePre != null && beforePre.isNotEmpty) {
        yield MeiliHighlightableStringPart(
            text: beforePre, isHighlighted: false);
      }
