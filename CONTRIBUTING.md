...
```bash
# Tests
docker compose run --rm package bash -c "dart pub get && dart pub get -C tool && dart run test --concurrency=2"
# Linter
docker compose run --rm package bash -c "dart pub get && dart pub get -C tool && dart analyze"
```
