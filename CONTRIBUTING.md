...
1. Make sure that the contribution you want to make is explained or detailed in a GitHub issue! Find an [existing issue](https://github.com/themisir/meilisearch-dart/issues/) or [open a new one](https://github.com/themisir/meilisearch-dart/issues/new).
...
6. [Submit the branch as a PR](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request-from-a-fork) pointing to the `master` branch of the main meilisearch-python repository. A maintainer should comment and/or review your Pull Request within a few days. Although depending on the circumstances, it may take longer.<br>
 We do not enforce a naming convention for the PRs, but **please use something descriptive of your changes**, having in mind that the title of your PR will be automatically added to the next [release changelog](https://github.com/themisir/meilisearch-dart/releases/).

## Development Workflow

### Setup

Install [Dart SDK](meilisearch/meilisearch-python) or [Flutter SDK](https://flutter.dev/docs/get-started/install) (which includes Dart SDK) using guides on the official website.

```bash
$ pub get
# Or if you're using flutter sdk
$ flutter pub get
```
...
Make a PR modifying the file [`pubspec.yaml`](/meilisearch/pubspec.yaml) with the right version.

```yaml
version: X.X.X
```

Once the changes are merged on `master`, you can publish the current draft release via the [GitHub interface](https://github.com/themisir/meilisearch-dart/releases).
...
- The PR title should be accurate and descriptive of the changes. The title of the PR will be indeed automatically added to the next [release changelogs](https://github.com/themisir/meilisearch-dart/releases/).
